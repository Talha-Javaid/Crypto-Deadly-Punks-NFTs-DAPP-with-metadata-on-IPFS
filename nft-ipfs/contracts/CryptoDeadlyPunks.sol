...
contract CryptoDeadlyPunks is ERC721Enumerable, Ownable {
     ...
     */
    constructor(string memory baseURI) ERC721("CryptoDeadlyPunks", "CDP") {
    ...
    function mint() public payable onlyWhenNotPaused {
        require(
            ...
            "Exceed maximum CryptoDeadlyPunks supply"
        );
